...
public class SpringKafkaConfiguration {
    ...
    public class ReactiveKafkaConfiguration {
        ...
        Map<String, Object> kafkaConsumerConfiguration() {
            ...
            configuration.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServersConfig);
        ...
        @Bean
        ReceiverOptions<String, String> kafkaReceiverOptions(@Value("${kafka.topic.request-topic}") String[] inTopicName) {
